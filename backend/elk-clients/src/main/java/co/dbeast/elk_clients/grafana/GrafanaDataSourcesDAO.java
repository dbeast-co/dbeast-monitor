...
public class GrafanaDataSourcesDAO implements IGrafanaDAO {
    private static final Logger logger = LogManager.getLogger();
    private final String ROOT_API = "/api/datasources";
    ...
    public JsonNode delete(final RestClient client,
        ...
        try {
        response = grafanaDbProvider.processLowLevelDELETERequest(
                client,
                API);
        }
        catch (RuntimeException e){
            logger.warn(JSONUtils.stringToJSON("Error in the Data source delete process. API: " + e));
            throw e;
        }
        return JSONUtils.stringToJSON(response);
    }
