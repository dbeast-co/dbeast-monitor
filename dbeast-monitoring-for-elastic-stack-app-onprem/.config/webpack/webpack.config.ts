    ...
    rules: [
      {
        ...
        use: {
          ...
          options: {
            jsc: {
              baseUrl: '/Users/yevgenylevin/Documents/Develop/DBeast/dbeast-monitor/dbeast-monitoring-for-elastic-stack-app-onprem/src',
              target: 'es2015',
              loose: false,
              parser: {
                syntax: 'typescript',
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: '../../dashboards/*.json', to: './dist/dashboards', force: true  }, // Custom dashboards folder
