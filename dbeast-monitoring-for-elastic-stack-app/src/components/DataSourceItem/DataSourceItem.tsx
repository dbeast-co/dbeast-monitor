...
export class DataSourceItem extends PureComponent<Props, ClusterStatsItemState> {
    ...
    async componentDidMount() {
        ...
        if (this.state.status !== 'ERROR') {
            await getBackendSrv()
                .get(`/api/datasources/proxy/uid/${this.props.dataSourceItem.uid}/_cluster/health?filter_path=unassigned_shards`)
                .then((health: any) => {
                    this.setState({
