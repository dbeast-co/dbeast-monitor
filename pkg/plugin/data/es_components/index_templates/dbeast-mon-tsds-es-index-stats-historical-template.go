...
const dbeastMonTsdsEsIndexStatsHistoricalTemplateContent string = `
{
  "index_patterns": [
...
func init() {
	dataWarehouse.AppendIndexTemplate("dbeast-mon-tsds-es-index-stats-historical-template", dbeastMonTsdsEsIndexStatsHistoricalTemplateContent)
}
