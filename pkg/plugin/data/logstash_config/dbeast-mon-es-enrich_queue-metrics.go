...
const dbeastMonEsEnrichQueueMetricsContent string = `
input{
  http_poller {
...
func init() {
	dataWarehouse.AppendLogstashConfig("dbeast-mon-es-enrich_queue-metrics", dbeastMonEsEnrichQueueMetricsContent)
}
