...
const dbeastMonEsIngestPipelinesMetricsContent string = `
input{
  http_poller {
...
func init() {
	dataWarehouse.AppendLogstashConfig("dbeast-mon-es-ingest_pipelines-metrics", dbeastMonEsIngestPipelinesMetricsContent)
}
